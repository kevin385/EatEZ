...
<html>
  ...
  <head>
    <title> Manager Login | EatEZ </title>
  </head>
...
?>  
  <div class="col-xs-9">  
    <div class="form-area" style="padding: 0px 100px 100px 100px;">
      <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR RESTAURANT DETAILS </h3>
  ...
  <?php } ?>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ENTER RESTAURANT DETAILS</h3>
