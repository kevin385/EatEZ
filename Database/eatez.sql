...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2019 at 09:30 AM
...
('user1', 'Mark H.', 'mark@gmail.com', '998696572', 'Maharashtra', 'password1'),
('user2', 'Rob Chapman', 'rob@gmail.com', '8779546521', 'Hyderabad', 'password2'),
('user3', 'Russell P.', 'russell@gmail.com', '9547123658', 'Gujarath', 'password3');
...
('manager1', 'Tom J.', 'manager1@gmail.com', '8654751259', 'Karnataka', 'password1'),
('manager2', 'Eric Maine', 'manager2@gmail.com', '9632587412', 'Bihar', 'password2'),
('manager3', 'Jimmy Page', 'manager3@gmail.com', '9541258761', 'Goa', 'password3');
...
--
DELIMITER $$
CREATE TRIGGER `ondelete` AFTER DELETE ON `orders` FOR EACH ROW UPDATE restaurants SET ordercount=ordercount-1 WHERE restaurants.R_ID = OLD.R_ID
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `onorder` AFTER INSERT ON `orders` FOR EACH ROW UPDATE restaurants SET ordercount=ordercount+1 WHERE restaurants.R_ID = NEW.R_ID
$$
DELIMITER ;
...
INSERT INTO `restaurants` (`R_ID`, `name`, `email`, `contact`, `address`, `M_ID`, `ordercount`) VALUES
(1, 'Restaurant1', 'contact@restaurant1.com', '7998562145', 'Karnataka', 'manager1', 0),
(2, 'Restaurant2', 'contact@restaurant2.com', '9887546821', 'Bihar', 'manager2', 0),
(3, 'Restaurant3', 'contact@restaurant3.com', '7778564231', 'Goa', 'manager3', 0);
